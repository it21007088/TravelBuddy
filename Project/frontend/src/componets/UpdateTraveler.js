...
console.log(UpdateTraveler);
        ...
        axios.put( `http://localhost:8070/traveler/update/${id}`,UpdateTraveler).then(()=>{
            alert("traveler details Edited")
        ...
        console.log(UpdateTraveler); //printing the sent form data on console.log f12
    ...
    return (
        <div className="container" >
            ...
            <div class="col-md-6"><br/>
            <label for="inputNum" class="form-label">Traveler License Number</label>
            <input type="text" class="form-control" 
            onChange={(e)=>{
            ...
            <div className="col-md-6">
                <button type="submit" class="btn btn-primary">Update traveler Details</button>
                &nbsp;&nbsp;&nbsp;
