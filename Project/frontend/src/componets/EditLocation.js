...
function EditLocation (){
  ...
  //add notify msg
  const notify = () => toast("Successfully location Edited");
      ...
      useEffect(()=>{
            ...
            function getLocations () {
              ...
              .then((res)=>{
                ...
                setDistric(res.data.location.date);
...
{/* //----------------------------------------------------------------------------------------------Top Navigation End-------------------------------------------------- */}
      ...
      <div className="form-group">
                ...
                <option defaultValue={form.district}>{form.district}</option>
